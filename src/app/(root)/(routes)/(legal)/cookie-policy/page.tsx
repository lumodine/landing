    ...
    <main className="py-12 space-y-12">
      <section className="text-center">
        <div className="container space-y-4">
          <h1 className="text-4xl font-bold text-brand">Çerez Politikası</h1>
      ...
      <section>
        <div className="container space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Çerez Nedir?</h2>
          <p className="text-gray-600">
      ...
      <section>
        <div className="container space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Kullanılan Çerez Türleri</h2>
      ...
      <section>
        <div className="container space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Çerezlerin Kullanımı</h2>
          <p className="text-gray-600">
      ...
      <section>
        <div className="container space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Çerezlerin Yönetimi</h2>
          <p className="text-gray-600">
