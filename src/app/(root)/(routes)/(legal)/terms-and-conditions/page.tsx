    ...
    <main className="py-12 space-y-12">
      <section className="text-center">
        <div className="container space-y-4">
          <h1 className="text-4xl font-bold text-brand">Kullanım Şartları</h1>
      ...
      <section>
        <div className="container space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Kullanıcı Yükümlülükleri</h2>
      ...
      <section>
        <div className="container space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Fikri Mülkiyet Hakları</h2>
          <p className="text-gray-600">
      ...
      <section>
        <div className="container space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Sorumluluk Reddi</h2>
          <p className="text-gray-600">
      ...
      <section>
        <div className="container space-y-4">
          <h2 className="text-2xl font-semibold text-gray-800">Şartların Değiştirilmesi</h2>
          <p className="text-gray-600">
