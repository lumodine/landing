  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-6">
      <header className="w-full max-w-4xl text-center mb-12">
        ...
        <p className="text-gray-600 mt-2">QR Menü Sistemi ile işletmenizi bir adım öne taşıyın.</p>
      </header>
      ...
      <section className="grid gap-8 w-full max-w-4xl">
        <div className="p-6 bg-white shadow rounded-md">
          ...
          <p className="text-gray-600 mt-2">
            LumoDine, kafeler ve restoranlar için modern QR Menü çözümleri sunar. İşletmenizi daha
            erişilebilir ve etkili hale getirin.
          </p>
        </div>
